 /***********************************************************************
* FILENAME : allocationStrategyWorstFitTest.c 
*
* DESCRIPTION : Lab 03
* 				Test file to test worst fit method.
...
void testWorstFit(){
    ...
    log(INFO, "main", "LOG710 - LAB03 - TEST WORST FIT ALGORITHM \n", __LINE__);
    ...
    setAllocationStrategy(WORST_FIT);
    initmem(128);
